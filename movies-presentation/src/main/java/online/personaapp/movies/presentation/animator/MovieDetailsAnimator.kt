package online.personaapp.movies.presentation.animator
...
import online.personaapp.core.extension.cancelTransition
...
@Inject constructor() {
  ...
  internal fun postponeEnterTransition(
      activity: FragmentActivity) = activity.postponeEnterTransition()
  ...
  internal fun fadeVisible(viewContainer: ViewGroup, view: View) = beginTransitionFor(viewContainer,
      view, View.VISIBLE)

  internal fun fadeInvisible(viewContainer: ViewGroup, view: View) = beginTransitionFor(
      viewContainer, view, View.INVISIBLE)
